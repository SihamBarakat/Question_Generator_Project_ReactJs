...
const DocHome =()=> {
   ...
   <section class="flex">
      ...
      <Link to="/DocHome"class="logo" >Doctor</Link>
...
<div class="side-bar">
   ...
   <Link to='/TeamDoc'><i class="fas fa-question"></i><span>about</span></Link>
   <Link to='/ShowAllExams1'><i class="fas fa-graduation-cap"></i><span>Exams</span></Link>
   <Link to='/Contactd'><i class="fas fa-headset"></i><span>contact us</span></Link>
...
<div class="more-btn">
<Link to='/question'class="inline-option-btn">Add Questions</Link> <br/>
...
<section class="courses">
   ...
   <div class="more-btn">
   <Link to='/ShowAllExams2'class="inline-option-btn">view all Exams</Link>
